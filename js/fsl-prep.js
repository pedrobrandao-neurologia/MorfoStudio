...
// Funções puras sobre typed arrays, usadas pelo preprocess-worker (nativo) e pelo
// mask-worker (conformado). Ver README, seção "Pré-processamento estilo FSL".
//
...
import { otsuThreshold } from './n4.js'
